/*** jQuery.cssAssist ver.1.7.5 : jQuery plugin , modified 2015.07.21 ***/
/*** Licence: MIT Licecse ***/
/*** Git: https://github.com/miztakagi/jQuery.cssAssist.git ***/
/*** created by miz.takagi@gmail.com ***/
            ...
            $('[class*='+setArray[i]+']').each(function() { // クラスを個別に処理
                ...
                if(res){ // 値が設定されていたら
                    ...
                    if(propArray[i]=='vertical-align'){
                        $(this).wrap("<div style='display:table' />"); // vertical-align の場合はtable属性の要素で包括して
                        $(this).css('display','table-cell'); // 自要素をtable-cellに設定する
                    }
                    if(propArray[i]=='margin'){
                        $(this).css('display','table'); // 自要素をtableに設定する
